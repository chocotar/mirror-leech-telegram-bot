...
from bot import Interval, parent_id, INDEX_URL, BUTTON_FOUR_NAME, BUTTON_FOUR_URL, BUTTON_FIVE_NAME, BUTTON_FIVE_URL, \
...
class MirrorListener:
    ...
    def onDownloadComplete(self):
        ...
        if self.isLeech:
            ...
            drive = GoogleDriveHelper(up_name, driveId=parent_id[self.driveId], self)
...
def _mirror(bot, message, isZip=False, extract=False, isQbit=False, isLeech=False, pswd=None, multi=0, isDrive=False):
